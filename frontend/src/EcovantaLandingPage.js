      ...
      >
        ...
        >
          ...
          >
            ...
            <button style={secondaryButtonStyle}>Book Demo</button>
...
>
      ...
      >
        ...
        >
          <div>
            ...
            >
              <button style={primaryButtonLargeStyle}>Start Free</button>
              <button style={secondaryButtonLargeStyle}>Book Demo</button>
            </div>
                ...
                >
                  <MiniPanel title="Benchmark Comparison">
                    <div style={barRow}>
                      <span>Company</span>
                      <div style={barTrack}>
                        <div style={{ ...barFill, width: "78%", background: "#5b8db8" }} />
                      </div>
                    </div>
                    <div style={barRow}>
                      <span>Sector Avg</span>
                      <div style={barTrack}>
                        <div style={{ ...barFill, width: "65%", background: "#c7a86d" }} />
                      </div>
                    </div>
                  </MiniPanel>
            ...
            <div style={analyticsCardStyle}>
              ...
              <div style={{ marginTop: "18px" }}>
                ...
                <div style={barRow}>
                  ...
                  <div style={barTrack}>
                    <div style={{ ...barFill, width: "82%", background: "#6fa287" }} />
                  </div>
                </div>
              </div>
            </div>
      ...
      >
        ...
        >
          ...
          >
            <button style={finalPrimaryButtonStyle}>Start Free</button>
            <button style={finalSecondaryButtonStyle}>Book Demo</button>
          </div>
        </div>
      </section>
